...
public class SaveSelectCharTexture : MonoBehaviour {
	...
	void Start () {
		Hats = GameObject.Find ("PlayerMaterialHolder").GetComponent<UnityMaterialHolder>().Hats;
		Faces = GameObject.Find ("PlayerMaterialHolder").GetComponent<UnityMaterialHolder>().Faces;
		Shirts = GameObject.Find ("PlayerMaterialHolder").GetComponent<UnityMaterialHolder>().Shirts;
		Pants = GameObject.Find ("PlayerMaterialHolder").GetComponent<UnityMaterialHolder>().Pants;

		NCHats = GameObject.Find ("PlayerMaterialHolder").GetComponent<UnityMaterialHolder>().NCHats;
		NCFaces = GameObject.Find ("PlayerMaterialHolder").GetComponent<UnityMaterialHolder>().NCFaces;
		NCShirts = GameObject.Find ("PlayerMaterialHolder").GetComponent<UnityMaterialHolder>().NCShirts;
		NCPants = GameObject.Find ("PlayerMaterialHolder").GetComponent<UnityMaterialHolder>().NCPants;
	...
	{
		SaveLoad.Load(int.Parse(this.name));
